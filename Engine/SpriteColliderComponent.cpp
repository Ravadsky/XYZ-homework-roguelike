...
SpriteColliderComponent::SpriteColliderComponent(Object* gameObject) : ColliderComponent(gameObject)
{
	...
	GetPhysicsSystem()->Subscribe(this);
...
SpriteColliderComponent::~SpriteColliderComponent()
{
	...
	GetPhysicsSystem()->Unsubscribe(this);
}
